        ...
        in
        {
          ...
          kristian@nix-home = lib.nixosSystem {
            ...
            specialArgs = {
              inherit inputs outputs stateVersion;
              hostname = "nix-home";
              # herelinkSSID = "herelink0";
              username = "kristian";
              desktop = "gnome";
              # role = "gateway"; # installer/operator/gateway/headquarter
              # hardwareConfig = "surface-go-4";
            };
          ...
          iso-installer = lib.nixosSystem {
            ...
            specialArgs = {
              inherit inputs outputs stateVersion;
              hostname = "d10-nix-installer";
              username = "kristian";
              desktop = "gnome";
              # role = "installer"; # installer/operator/gateway/headquarter
              # hardwareConfig = "iso"; # Can also be "surface-go-4"
            };
          };
        };
    };
